    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-purple-400/10 to-pink-400/10 blur-3xl"></div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="relative p-8 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                />
                                <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-purple-500/0 to-pink-500/0 hover:from-purple-500/10 hover:to-pink-500/10 pointer-events-none transition-all duration-200"></div>
                            </div>
                        </div>
                        ...
                        <button 
                            type="submit" 
                            className="w-full py-3 px-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-purple-500/25 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-800 transform hover:scale-105 transition-all duration-200"
                        >
                            Sign In
                        </button>
                        ...
                        <button 
                            ...
                            className="w-full py-3 px-4 bg-transparent border-2 border-gray-600 hover:border-purple-500 text-white font-semibold rounded-lg hover:bg-purple-500/10 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-all duration-200 flex items-center justify-center space-x-3"
                        >
