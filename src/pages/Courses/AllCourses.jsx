...
const AllCourses = () => {
    ...
    // useEffect থেকে টোকেন সম্পর্কিত লজিক সরিয়ে দেওয়া হয়েছে
    useEffect(() => {
        const fetchAllCourses = async () => {
            setLoading(true);
            setError(null); // পূর্ববর্তী এরর রিসেট করা হচ্ছে
            try {
        ...
        fetchAllCourses();
    }, []); // খালি dependency array, তাই এটি শুধু একবার রান হবে
    ...
    // Loading ও Error UI আগের মতোই থাকবে
    if (loading) {
    ...
    const CourseCard = ({ course }) => (
        <div className="group bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl overflow-hidden hover:border-blue-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-1">
            ...
            <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link 
                        ...
                        className="group/btn flex items-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-4 py-2 rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/25"
                    >
                        <span>Details</span>
